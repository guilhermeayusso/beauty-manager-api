...
import br.com.fiap.beautymanagerapi.adapters.gateways.servico.JpaServicoRepository;
...
public class JpaServicoRepositoryTest {

    @Autowired
    private JpaServicoRepository jpaServicoRepository;
    @Autowired
    ...
    public void testSaveServico(){
        ...
        ServicoEntity savedServico = jpaServicoRepository.save(servico);
    ...
    public void testDeleteServico() {
        ...
        Optional<ServicoEntity> optionalServicoBeforeDelete = jpaServicoRepository.findById(11L);
        assertThat(optionalServicoBeforeDelete.isPresent()).isTrue(); // Verifica que o serviço existe

        // Realiza a deleção
        jpaServicoRepository.deleteById(11L);

        // Busca o serviço novamente para garantir que foi deletado
        Optional<ServicoEntity> optionalServicoAfterDelete = jpaServicoRepository.findById(11L);
