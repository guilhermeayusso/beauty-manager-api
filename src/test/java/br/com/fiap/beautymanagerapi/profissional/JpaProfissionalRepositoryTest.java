...
import br.com.fiap.beautymanagerapi.adapters.gateways.profissional.JpaProfissionalRepository;
...
public class JpaProfissionalRepositoryTest {

    @Autowired
    private JpaProfissionalRepository jpaProfissionalRepository;
    @Autowired
    ...
    public void testSaveProfissional() {
        ...
        ProfissionalEntity profissionalSaved = jpaProfissionalRepository.save(profissional);
