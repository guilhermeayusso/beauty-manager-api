...
import br.com.fiap.beautymanagerapi.adapters.gateways.localizacao.JpaLocalizacaoRepository;
...
public class JpaLocalizacaoRepositoryTest {

    @Autowired
    private JpaLocalizacaoRepository jpaLocalizacaoRepository;
    ...
    public void testFindLocationsWithinRadius(){
        List<LocalizacaoEntity> result = jpaLocalizacaoRepository.findLocationsWithinRadius(-23.55052,-46.633308,50);
    ...
    public void testSaveLocation(){
        ...
        LocalizacaoEntity localizacaoSaved = jpaLocalizacaoRepository.save(localizacao);
